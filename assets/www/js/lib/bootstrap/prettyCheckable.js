            ...
            $(element).on('change', function(e) {
                ...
                if (e.originalEvent === undefined) {
                    ...
                    if (isChecked === true) {
                        ...
                        //$(".prettyradio").closest(".prettyradio:has(a.checked)").find("input").attr("id")
                        fakeCheckable.attr("data-id", $(clickedParent).closest(".prettyradio:has(a.checked)").find("input").attr("id"));
        ...
        element.find('a:first, label').on('touchstart click', function(e){
            ...
            if (window.ko) {
                ...
                if (input.prop('checked')) {
                    ...
                    fakeCheckable.attr("data-id", $(input).attr("id"));
