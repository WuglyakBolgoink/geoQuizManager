...
//                console.log(pos);
        ...
        ft.upload(encodeURI(img), encodeURI("http://ae.subsession.net/projects/mobi/upload.php"), function(res) {
    ...
    getGeoPos: function() {
        ...
        navigator.geolocation.getCurrentPosition(function(position) {
            ...
            self.$("#fLng").html((self.gPos.lng) ? self.gPos.lng : "Not found");
            self.$("#fLat").html((self.gPos.lat) ? self.gPos.lat :  "Not found");
            self.$("#relIcon").removeClass("fa-spin");

        }, function(error) {
            self.gPos.status = false;
            self.$("#fLng").html((self.gPos.lng) ? self.gPos.lng : "Error...");
            self.$("#fLat").html((self.gPos.lat) ? self.gPos.lat :  "Error...");
            self.$("#relIcon").removeClass("fa-spin");
        });
